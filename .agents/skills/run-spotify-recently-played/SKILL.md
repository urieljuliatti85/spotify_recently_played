...
headlessly with **`.Codex/skills/run-spotify-recently-played/driver.mjs`** — it
...
```bash
node .Codex/skills/run-spotify-recently-played/driver.mjs smoke
```
...
```bash
node .Codex/skills/run-spotify-recently-played/driver.mjs up
node .Codex/skills/run-spotify-recently-played/driver.mjs seed
node .Codex/skills/run-spotify-recently-played/driver.mjs shot listeners
node .Codex/skills/run-spotify-recently-played/driver.mjs api "/api/plays?limit=2"
node .Codex/skills/run-spotify-recently-played/driver.mjs unseed
node .Codex/skills/run-spotify-recently-played/driver.mjs down
```
